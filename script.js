...
function gamesToTable(gamesList,pc) {
	for (i = 0; i < gamesList.length; i++) {
		...
		if ($("tr#"+game.appid).length) {
			...
			try {
				var row = "<tr class=\"game_cell\" id=\""+game.appid+"\"><td><img class=\"game_img\" src="+gameImg+"></td><td class=\"game_name\">"+game.name+"</td><td>"+timePlayed+"</td><td class=\"pc\" pcnb="+pc+"></td></tr>"
			}
			catch{
